...
export default function () {
  http.get(`http://127.0.0.1:3000/qa/questions?product_id=3000`);
  http.get(`http://127.0.0.1:3000/qa/questions/3000/answers?page=1&count=5`);
  ...
  http.post(`http://127.0.0.1:3000/qa/questions/3000/answers`, JSON.stringify(newAnswer), {
    headers: { 'Content-Type': 'application/json' },
  });

  http.put(`http://127.0.0.1:3000/qa/questions/3000/helpful`);
  http.put(`http://127.0.0.1:3000/qa/answers/3000/helpful`);
  http.put(`http://127.0.0.1:3000/qa/questions/3000/report`);
  http.put(`http://127.0.0.1:3000/qa/answers/3000/report`);
